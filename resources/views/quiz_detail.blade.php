        ...
        <main class="student-main">
            ...
            <div class="student-page-content final-quiz-content">
                ...
                <section class="quiz-information-card" aria-labelledby="quiz-description-title">
                    <dl>
                        <dt>Jenis Quiz</dt><dd>Pilihan Jawaban</dd>
                        <dt>Jumlah Soal</dt><dd>{{ $questionCount > 0 ? $questionCount : 'Tersedia saat kuis dimulai' }}</dd>
                        <dt>Durasi</dt><dd>{{ $timeLimit > 0 ? max(1, (int) ceil($timeLimit / 60)).' Menit' : 'Tidak dibatasi' }}</dd>
                        <dt>Poin</dt><dd>10 Poin</dd>
                    </dl>
    ...
    @if ($showExpired)
        <div class="material-modal-layer quiz-modal-layer" data-quiz-expired-layer>
            <section class="assignment-alert-modal quiz-expired-modal" role="dialog" aria-modal="true" aria-labelledby="quiz-expired-title">
                <button class="material-modal-close" type="button" data-quiz-expired-close aria-label="Tutup pemberitahuan batas akses"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><path d="m15 9-6 6"></path><path d="m9 9 6 6"></path></svg></button>
    ...
    @if ($earnedBadge)
        <div class="material-modal-layer material-feedback-layer" data-quiz-badge-layer hidden>
            <section class="material-feedback-modal material-badge-modal" role="dialog" aria-modal="true" aria-labelledby="quiz-badge-title">
                <button class="material-modal-close" type="button" data-quiz-badge-close aria-label="Tutup pemberitahuan badge"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><path d="m15 9-6 6"></path><path d="m9 9 6 6"></path></svg></button>
